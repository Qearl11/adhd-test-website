...
questions_42 = [
    ...
    {"text": "我经常忘记他人的重要细节，比如生日或名字。", "type": "inattention"},
    {
    ...
    {"text": "我在集体活动或社交场合中难以保持专注。", "type": "inattention"},
    {"text": "我经常忘记约会、截止日期或其他责任。", "type": "inattention"},
    {
    ...
    {"text": "我常常不自觉地踱步、敲打或做重复动作。", "type": "hyperactivity"},
